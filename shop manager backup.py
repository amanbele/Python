...
class App(Tk.Tk):
	...
	def __init__(self):
		...
		self.item_prc_var = Tk.StringVar()
	...
	def add_item(self):
		...
		def insert_item(id, name, prc, cat):

			# string command
			ir_str = "insert into shop(id, name, prc, cat) values('%d', '%s', '%d', '%s')"

			# define args
			args = (id, name, prc, cat)
		...
		# pass all inputs to insert rows func
		insert_item(i, n, p, c)
